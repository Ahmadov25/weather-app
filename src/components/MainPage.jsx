  ...
  useEffect(() => {
    navigator.geolocation.getCurrentPosition(position => {
      ...
      const fetchCountry = async function (city) {
        ...
        const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?${param}&appid=aa47bc4dd6faa742921b4d33fa26596d&units=metric`)
  ...
  return (
    <div className='weather-app' style={{ backgroundImage: `url(${bgImage})` }}>
      <div className="container">
        ...
        <div >
          ...
          <div className='weather'>
            <img src={icons[weatherDetails.weather]} alt="icon" width={75} height={75} />
      ...
      <div className='panel'>
        ...
        <ul>
          {regions.map(region => <li key={nanoid()} onClick={() => selectRegion(region)} className='city'>{region}</li>)}
        </ul>
        <ul>
